...
$stmtMascota->execute();
$resultadoMascota = $stmtMascota->get_result();

if ($resultadoMascota->num_rows === 0) {
    header("Location: ../cliente/clientes.php");
    exit();
}
...
<body>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-9 col-xl-10 py-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 border-bottom">
                    <h1 class="m-0">Edición de Mascota</h1>

                    <button type="button" class="btn btn-secondary"
                        onclick="window.location.href='../cliente/editar-cliente.php?id=<?= $mascota['Cliente_Id'] ?>'">
                    ...
                    <div class="row">
                            ...
                            <select class="form-select" id="tipo" required>
                                ...
                                <?php foreach ($especies as $especie): ?>
                                    <option value="<?= $especie['Especie_Id'] ?>"
                                        <?= ($especie['Especie_Id'] == $mascota['Especie_Id']) ? 'selected' : '' ?>>
                                        <?= $especie['Nombre'] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <textarea class="form-control" id="observaciones"
                                rows="3"><?= htmlspecialchars($mascota['Observaciones']) ?></textarea>
                        </div>
    ...
    <script src="editar-mascota.js"></script>
